class IngamePanelCustomPanel extends TemplateElement {
    ...
    connectedCallback() {
        ...
        // this.inputUrlElement = document.getElementById("InputUrl");
        ...
        if (this.ingameUi) {
            ...
            // this.inputUrlElement.addEventListener('keypress', function (e) {
            //     if (e.key === 'Enter') {
            //         self.iframeElement.src = this.inputUrlElement.value;
            //     }
            // });
            ...
            this.ingameUi.addEventListener("panelActive", (e) => {
                ...
                if (self.iframeElement) {
                    self.iframeElement.src = 'http://localhost:8965/ol/index.html';
                }
            });
